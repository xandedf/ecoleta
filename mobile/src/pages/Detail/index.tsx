...
// Criando uma interface para assumir a estrutura do params passado pela rota
interface Params {
  point_id: number;
}
...
const Detail = () => {
    ...
    // UseEffect para buscar os dados do ponto via API
    useEffect(() => {
    ...
    function handleWhatsapp() {
      Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho intesse no descarte de resíduos`);
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Text style={styles.pointItems}>
                  {data.items.map(item => item.title).join(', ')} {/* Separa os itens por virgula */}
                </Text>
